...
Configuration settings for the server's safety policy.

NOTE: This section is expected to gain more options as safety tooling is explored further.
...
* `policyserv_url` (string): The base URL to use when contacting the policyserv instance. When empty or not provided, the safety policy support is disabled.
* `policyserv_api_key` (string): The API key for the server-centric API of the above-provided policyserv instance. When empty or not provided, the safety policy support is disabled.

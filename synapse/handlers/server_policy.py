...
from synapse.api.errors import SynapseError, HttpResponseException, Codes
...
class ServerPolicyHandler:
    ...
    * Search Redirection - When a user tries to search for a room in our directory, the
    ...
    def __init__(self, hs: "HomeServer"):
        ...
        self._has_policyserv = bool(self._policyserv_url) and bool(self._policyserv_api_key)
    ...
    async def _policyserv_check(self, check_type: str, body: bytes) -> None:
        ...
        try:
            ...
            raise SynapseError(HTTPStatus.INTERNAL_SERVER_ERROR, "unknown error contacting policyserv")
        ...
        if response.code != 200:
            ...
            logger.info("policyserv rejected request: %s", ex)
            raise ex
